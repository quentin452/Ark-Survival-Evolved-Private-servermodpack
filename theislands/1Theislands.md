...
* 2994599390 : HGPlus - Pull Resources - ReUpload

**fixe**
 
* fix crash when placing torches/fabricator from Structure + by removing HGPlus - Pull Resources - ReUpload
...
* fix dinos harvesting/wandering does not work by removing Ark Steampunk

**other**

* reduced significantly loading time of Structure Plus (+) by removing Ark Steampunk
...
* fix crash caused by cryopods by removing Configurable Cryopods+
...
* craftable resource removed is too much abuse
...
* dino garage is removed because doesn't work
...
* since we removed Ark Automated , we need to add these mods
...
* Finally fixed FPS lags by removing Cross Genesis mods
...
* 2899371682 : Undead Island Extension Fixes
...
* fix modpack taking long time REALLY to load by removing Shads Atlas Imports
...
* HOTFIX CRASH WHEN DOWNLOADING AUTOMATED ARK MODS WHEN YOU ARE ON SERVER MENUS BY REMOVING IT
...
* 705395680 : Gigantic Floating Island MapExtension
* 553034096 : Water Well
* 2016338122 : Shiny! Dinos
* 524383474 : Wood table
...
* fix crash caused by level up counter items
...
* fix stat dino drops using dino levelling assistant,idk why but when the stat are too high level the mod make a stat drops
...
* 718759823 : Rare Flower And Mushroom Cheat Mod
...
* 1379756928 : Gyrosphere
* 671591278 : OriginalWiredSolarPanels
* 2791223457 : Auto Feeder
* 2368935058 : Place Anywhere Oil Pump, Gas Pump, and Water Well
...
* 631205233 : ☠ OceanTide - TheIsland ☠ 

**fixe**

* fix fps lag caused by 631205233 : ☠ OceanTide - TheIsland ☠ 

V1.52 TEST BUILD/BETA BUILD
...
* 2732765096 : Bloody Ark the Island Map Extension

V1.51 TEST BUILD/BETA BUILD
...
V1.50 TEST BUILD/BETA BUILD

**mods added**

* 1675895024 : No Untameables

V1.49 TEST BUILD/BETA BUILD
...
V1.47 TEST BUILD/BETA BUILD

**mods added**

* 631205233 : ☠ OceanTide - TheIsland ☠ 

V1.46 TEST BUILD/BETA BUILD
...
* 658112994 : Map Extension: Streichelzoo - Complete

V1.45 TEST BUILD/BETA BUILD

**mods deleted**

* 1402519919 : Improved flyers

**fixe**

* fix [#19](https://github.com/quentin452/Ark-Survival-Evolved-Private-servermodpack/issues/19)

V1.44 TEST BUILD/BETA BUILD
...
* 640975419 : Metal Storage (with Preview)
* 776661641 : No Spawn Zone
    
V1.42 TEST BUILD/BETA BUILD
...
* fix [#17](https://github.com/quentin452/Ark-Survival-Evolved-Private-servermodpack/issues/17)

V1.41 TEST BUILD/BETA BUILD
...
* 963660527 : GHG's Tranquilizer Stuff

V1.35 TEST BUILD/BETA BUILD
...
* Small boss mod have dodorex

V1.34 TEST BUILD/BETA BUILD
...
V1.31 TEST BUILD/UNSTABLE BUILD
...
* fix fps lag caused by Paleo ARK,Kraken's Better Dinos,ARK Additions

**other**

* reduce world loading time ~1min10(3 min to 1min50)

V1.30 TEST BUILD/UNSTABLE BUILD
...
* fix [#11](https://github.com/quentin452/Ark-Survival-Evolved-Private-servermodpack/issues/11)
* fix [#12](https://github.com/quentin452/Ark-Survival-Evolved-Private-servermodpack/issues/12)

V1.28 TEST BUILD/BETA BUILD
...
V1.24 TEST BUILD/BETA BUILD

**mods added**

* 1198392141 : Aqua Ark Version 1.0
* 1575498290 : Creative Mode plus
...
1.22 TEST BUILD/UNSTABLE BUILD
...
V1.20 TEST BUILD/UNSTABLE BUILD
